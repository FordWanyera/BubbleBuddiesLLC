...
var _uniInfo__getDocument = import_graphql_tag.default`
  ...
  getVendia_UniInfo {
    ...
    `;
var patient__getDocument = import_graphql_tag.default`
    query patient__get($id: ID!, $version: Int) {
  get_patient(id: $id, version: $version) {
    ... on Self_patient {
      _id
      _owner
      name
    ...
    ... on Self_patient_Partial_ {
      _id
      _owner
      __alias__name: name
      __alias__patientPicture: patientPicture
      __alias__dob: dob
      __alias__insuranceNumber: insuranceNumber
      __alias__height: height
      __alias__weight: weight
      __alias__bloodPressure: bloodPressure
      __alias__temperature: temperature
      __alias__oxygenSaturation: oxygenSaturation
      __alias__uuid: uuid
      __alias__address: address
      __alias__currentMedications: currentMedications {
        medication
      }
      __alias__familyHistory: familyHistory
      __alias__currentlyEmployed: currentlyEmployed
      __alias__currentlyInsured: currentlyInsured
      __alias__icdHealthCodes: icdHealthCodes {
        code
      }
      __alias__allergies: allergies {
        allergy
      }
      __alias__visits: visits {
        patient
        dateTime
        notes
        hivViralLoad
    ...
    `;
var drug__getDocument = import_graphql_tag.default`
    query drug__get($id: ID!, $version: Int) {
  get_drug(id: $id, version: $version) {
    ... on Self_drug {
      _id
      _owner
      placebo
    ...
    ... on Self_drug_Partial_ {
      _id
      _owner
      __alias__placebo: placebo
      __alias__batchNumber: batchNumber
      __alias__id: id
    }
  }
}
    `;
var patient__listDocument = import_graphql_tag.default`
    query patient__list($nextToken: String, $limit: Int, $filter: Self_patient_FilterInput_, $order: [Self_patient_OrderInput_!]) {
  list_patientItems(
    nextToken: $nextToken
    limit: $limit
    filter: $filter
    ...
    `;
var drug__listDocument = import_graphql_tag.default`
    query drug__list($nextToken: String, $limit: Int, $filter: Self_drug_FilterInput_, $order: [Self_drug_OrderInput_!]) {
  list_drugItems(
    nextToken: $nextToken
    limit: $limit
    filter: $filter
    ...
    `;
var patient__addDocument = import_graphql_tag.default`
    mutation patient__add($input: Self_patient_Input_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $aclInput: Vendia_Acls_Input_) {
  add_patient(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
var patient__updateDocument = import_graphql_tag.default`
    mutation patient__update($id: ID!, $input: Self_patient_UpdateInput_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_patient_ConditionInput_, $aclInput: Vendia_Acls_Input_) {
  update_patient(
    id: $id
    input: $input
    syncMode: $syncMode
    ...
    `;
var drug__addDocument = import_graphql_tag.default`
    mutation drug__add($input: Self_drug_Input_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $aclInput: Vendia_Acls_Input_) {
  add_drug(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
var drug__updateDocument = import_graphql_tag.default`
    mutation drug__update($id: ID!, $input: Self_drug_UpdateInput_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_drug_ConditionInput_, $aclInput: Vendia_Acls_Input_) {
  update_drug(
    id: $id
    input: $input
    syncMode: $syncMode
    ...
    `;
var patient__removeDocument = import_graphql_tag.default`
    mutation patient__remove($id: ID!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_patient_ConditionInput_) {
  remove_patient(id: $id, syncMode: $syncMode, condition: $condition) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
var drug__removeDocument = import_graphql_tag.default`
    mutation drug__remove($id: ID!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_drug_ConditionInput_) {
  remove_drug(id: $id, syncMode: $syncMode, condition: $condition) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
var patient__onAddDocument = import_graphql_tag.default`
    subscription patient__onAdd {
  onAdd_patient {
    error
    result {
      _id
    ...
    `;
var patient__onRemoveDocument = import_graphql_tag.default`
    subscription patient__onRemove {
  onRemove_patient {
    error
    result {
      _id
    ...
    `;
var patient__onUpdateDocument = import_graphql_tag.default`
    subscription patient__onUpdate {
  onUpdate_patient {
    error
    result {
      _id
    ...
    `;
var drug__onAddDocument = import_graphql_tag.default`
    subscription drug__onAdd {
  onAdd_drug {
    error
    result {
      _id
    ...
    `;
var drug__onRemoveDocument = import_graphql_tag.default`
    subscription drug__onRemove {
  onRemove_drug {
    error
    result {
      _id
    ...
    `;
var drug__onUpdateDocument = import_graphql_tag.default`
    subscription drug__onUpdate {
  onUpdate_drug {
    error
    result {
      _id
    ...
    patient: {
      get(id, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(patient__getDocument, variables, wrappedRequestHeaders).then((res) => res.get_patient).then((res) => {
      ...
      list(options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(patient__listDocument, variables, wrappedRequestHeaders).then((res) => {
            var _a;
            const updatedRes = { ...res.list_patientItems, items: (_a = res.list_patientItems) == null ? void 0 : _a._patientItems };
            delete updatedRes._patientItems;
            return updatedRes;
          }).then((res) => {
      ...
      add(input, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(patient__addDocument, variables, wrappedRequestHeaders).then((res) => res.add_patient).then((res) => {
      ...
      update(input, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(patient__updateDocument, variables, wrappedRequestHeaders).then((res) => res.update_patient).then((res) => {
            const result = stripAliasPrefixesFromKeys(res == null ? void 0 : res.result);
            return { ...res, result };
          });
        }, "update_patient");
      ...
      remove(id, options) {
        const variables = { ...options, id };
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(patient__removeDocument, variables, wrappedRequestHeaders).then((res) => res.remove_patient);
        }, "remove_patient");
      },
      onAdd(handler) {
        return _subscribe({ query: patient__onAddDocument }, ({ data }) => {
          return handler(data.onAdd_patient);
        });
      },
      onRemove(handler) {
        return _subscribe({ query: patient__onRemoveDocument }, ({ data }) => {
          return handler(data.onRemove_patient);
        });
      },
      onUpdate(handler) {
        return _subscribe({ query: patient__onUpdateDocument }, ({ data }) => {
          return handler(data.onUpdate_patient);
        });
      }
    },
    drug: {
      get(id, options) {
        const variables = { ...options, id };
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(drug__getDocument, variables, wrappedRequestHeaders).then((res) => res.get_drug).then((res) => {
            return stripAliasPrefixesFromKeys(res);
          });
        }, "get_drug");
      },
      list(options) {
        const variables = options;
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(drug__listDocument, variables, wrappedRequestHeaders).then((res) => {
            var _a;
            const updatedRes = { ...res.list_drugItems, items: (_a = res.list_drugItems) == null ? void 0 : _a._drugItems };
            delete updatedRes._drugItems;
            return updatedRes;
          }).then((res) => {
            const items = stripAliasPrefixesFromKeys(res.items);
            return { ...res, items };
      ...
      add(input, options) {
        const variables = { ...options, input };
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(drug__addDocument, variables, wrappedRequestHeaders).then((res) => res.add_drug).then((res) => {
            const result = stripAliasPrefixesFromKeys(res == null ? void 0 : res.result);
            return { ...res, result };
          });
        }, "add_drug");
      ...
      update(input, options) {
        ...
        const variables = { ...options, id: _id, input: rest };
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(drug__updateDocument, variables, wrappedRequestHeaders).then((res) => res.update_drug).then((res) => {
            const result = stripAliasPrefixesFromKeys(res == null ? void 0 : res.result);
            return { ...res, result };
          });
        }, "update_drug");
      ...
      remove(id, options) {
        const variables = { ...options, id };
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(drug__removeDocument, variables, wrappedRequestHeaders).then((res) => res.remove_drug);
        }, "remove_drug");
      },
      onAdd(handler) {
        return _subscribe({ query: drug__onAddDocument }, ({ data }) => {
          return handler(data.onAdd_drug);
        });
      },
      onRemove(handler) {
        return _subscribe({ query: drug__onRemoveDocument }, ({ data }) => {
          return handler(data.onRemove_drug);
        });
      },
      onUpdate(handler) {
        return _subscribe({ query: drug__onUpdateDocument }, ({ data }) => {
          return handler(data.onUpdate_drug);
        });
      }
    }
  };
